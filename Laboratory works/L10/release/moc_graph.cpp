...
QT_MOC_LITERAL(3, 18, 7), // "remover"
QT_MOC_LITERAL(4, 26, 6), // "sorter"
QT_MOC_LITERAL(5, 33, 10) // "allremover"

    },
    "FormDialog\0adder\0\0remover\0sorter\0"
    "allremover"
};
...
void FormDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->remover(); break;
        case 2: _t->sorter(); break;
        case 3: _t->allremover(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
void *FormDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::GraphQueue"))
        return static_cast< Ui::GraphQueue*>(this);

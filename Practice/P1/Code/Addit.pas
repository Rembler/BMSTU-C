...
begin
  ...
  begin
    if (check2(edit4.text,length(edit4.text))=true) and
    (check1(edit5.Text,length(edit5.text))=true) then
    begin
      seek(men,0);
    ...
    begin
      if (check2(edit4.text,length(edit4.text))=false) then
        edit4.Text:='ERROR';
      if (check1(edit5.Text,length(edit5.text))=false) then
        edit5.Text:='ERROR';
    end;
  end;
end;
